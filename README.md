...
local Window = OrionLib:MakeWindow({Name = "PecinhAzz hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "PecinhAzz hub"})
...
W:AddLabel("[+] PecinhAzz hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "PecinhAzz hub(Noitification)",
